<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="employee_id" class="block mt-1 w-full" type="number"
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role"
                    class="block mt-1 w-full border-gray-300 dark:bg-gray-800 dark:border-gray-700 rounded-md">
